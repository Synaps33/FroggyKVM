	...
	void prepareKeyMap(){
		...
		switch(currentKeyboard){
			...
			case 3:
				...
				kmap[0]=new VirtualKeyboardMap(kmapW+LSHIFT,kmpaH,mainKeyOffsetX,mainKeyOffsetY,VirtualKeyboardMap.KEYMAP_LAYOUT_TYPE_10,0);
				...
				kmap[1]=new VirtualKeyboardMap(kmapW-LSHIFT,kmpaH/2,

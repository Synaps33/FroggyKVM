...
public interface RasterImageConsumer {
    /**
     * @param img the RasterImage requested by the consumer.
     * @param rui the RasterImage unique resource identifier.
     */
    void setImage(final RasterImage img, 
                  final String uri);
     ...
     */
    RunnableHandler getRunnableHandler();
}

...
public class Coordinates {
    ...
    System.out.println("Coordinates.convert");
        ...
        System.out.println("Coordinates.convert1");
        coordinate = Math.abs(coordinate);
        System.out.println("Coordinates.convert2");
        int deg = (int)coordinate;
        System.out.println("Coordinates.convert3");
        buffer.append(deg);
        buffer.append(":");

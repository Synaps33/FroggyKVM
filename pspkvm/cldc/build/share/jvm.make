...
JVM_STANDALONE_LIB_NAME = $(LIB_PREFIX)$(BINARY_NAME)standalone$(BUILD_EXT)$(LIB_SUFFIX)
...
JVM_STANDALONE_LIB = $(BIN_DIR)/$(JVM_STANDALONE_LIB_NAME)
...
GCC_PREFIX_mips    = $(GNU_TOOLS_DIR)/../bin/psp-
GCC_PREFIX_i386    =
GCC_PREFIX_sparc   =
GCC_PREFIX_powerpc =
...
$(JVM_STANDALONE_LIB): $(BUILD_PCH) $(EXE_OBJS) $(LIB_OBJS) $(LIBTEST_OBJS)
	$(A)echo "creating $@ ... "
	$(A)rm -f $@
	$(A)$(LIBMGR) $(LIB_FLAGS) $@ $(EXE_OBJS) $(LIB_OBJS) $(LIBTEST_OBJS)
	$(A)echo generated `pwd`/$@
...
$(JVM_EXE): $(CLDC_ZIP) $(EXE_OBJS) $(JVM_LIB) $(JVMX_LIB) $(JVMTEST_LIB)  $(JVM_STANDALONE_LIB)
ifeq ($(skip_link_image), true)
	$(A)touch $@
else
	$(A)echo "linking $@ ... "
	$(LINK) -o $@ $(EXE_OBJS) $(JVMX_LIB) $(JVMTEST_LIB) $(JVM_LIB)\
	     $(PCSL_LIBS) $(LINK_FLAGS)

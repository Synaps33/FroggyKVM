...
#if 1
unsigned char * _kni_parameter_base = 0;

#if ENABLE_INTERPRETATION_LOG
OopDesc*        _interpretation_log[INTERP_LOG_SIZE];
int             _interpretation_log_idx = 0;
#endif

OopDesc**       _old_generation_end = 0;
...
_KNI_HandleInfo* last_kni_handle_info = 0;
void* JVMObjectHeap_quick_vars = 0;

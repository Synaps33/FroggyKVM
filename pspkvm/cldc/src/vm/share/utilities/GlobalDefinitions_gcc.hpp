...
#ifndef _GLOBALDEFINITIONS_GCC_HPP_
#define _GLOBALDEFINITIONS_GCC_HPP_
...
// if everything else fails - we assume MIPS or x86
#if defined(__mips__) || defined(mips)
#  define BREAKPOINT __asm__ ("break")
#  define panic() __asm__ ("break")
#else
...
const jlong max_jlong = ((unsigned long long)min_jlong - 1);

#endif /* _GLOBALDEFINITIONS_GCC_HPP_ */

...
class Universe: public AllStatic {
 public:
  ...
  // Re-sync _raw_task_list from GC-maintained handle (call after allocations
  // that could have triggered GC and moved the task list array).
  static void refresh_raw_task_list() {
    _raw_task_list = task_list()->obj();
  }

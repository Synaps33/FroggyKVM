...
class JavaClass: public FarClass {
 ...
 public:
  ...
  void set_super(ReturnOop value) { obj_field_put(super_offset(), value); }
  void set_super(const Oop* value) { obj_field_put(super_offset(), value ? value->obj() : (ReturnOop)NULL); }
...
//!ENABLE_ISOLATES
  ...
  ReturnOop name() const {
    return (ReturnOop)raw_class_info()->_name;
  }         

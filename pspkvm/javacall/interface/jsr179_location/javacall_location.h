 ...
 * geographic location and orientation of the terminal.
 *
...
/** Maximum length of an extrainfo mimetype */
 ...
 */
typedef struct {
    /** Address Info fieldIs (see javacall_location_addressinfo_field) */
...
typedef struct {
    ...
    /** Pitch in degree within [-90.0, 90.0], JAVACALL_LOCATION_FLOAT_NAN if unknown */
    float pitch;            
    /** Roll in degree within [-180.0, 180.0), JAVACALL_LOCATION_FLOAT_NAN if unknown */
    float roll;

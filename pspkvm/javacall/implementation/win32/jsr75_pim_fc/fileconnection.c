...
/*
 * This is a prefix to be added to all windows logical drive names (C:, D:, etc.).
 * It is done as a workaround to pass a TCK. The test for path name length gets
 * URLs that are longer than actual file system paths. Because of this, the test
 * does not attempt to create paths too long for windows file systems.
 *
 * The workaround should be removed when the TCK test is officially excluded.
 */
#define DRIVE_PREFIX   L"windows_logical_drive_"
#define PREFIX_SIZE    ((int)(sizeof(DRIVE_PREFIX) - 2))
#define PREFIX_CHARS   (PREFIX_SIZE / 2)
...
static const javacall_utf16 photos_dir[]     = DRIVE_PREFIX L"C:/fc/photos/";
static const javacall_utf16 videos_dir[]     = DRIVE_PREFIX L"C:/fc/videos/";
static const javacall_utf16 graphics_dir[]   = DRIVE_PREFIX L"C:/fc/graphics/";
static const javacall_utf16 tones_dir[]      = DRIVE_PREFIX L"C:/fc/tones/";
static const javacall_utf16 music_dir[]      = DRIVE_PREFIX L"C:/fc/music/";
static const javacall_utf16 recordings_dir[] = DRIVE_PREFIX L"C:/fc/recordings/";
static const javacall_utf16 private_dir[]    = DRIVE_PREFIX L"C:/fc/private/";
